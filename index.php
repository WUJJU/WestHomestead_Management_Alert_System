...
?>
 ...
 var cater = window.location.search.match(/cater=(\w+)/);
  if(cater) {
  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <div id="content-1" style="display:inline">
...
<div id="content1" style="display:none;">
 ...
 $sql="SELECT owner_name,owner_address,city,ZIP,cellphone,email from property_owner  where owner_id='".$oid."' ";
...
<div id="content2" style="display:none;">
  ...
  $sql="SELECT pid,p_address,units,owner_name,state,P.owner_id from property P, property_owner PO where P.owner_id=PO.owner_id and P.state='".$cat."' ";
